document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      curriculum_heading: "Shaping insightful thinkers and active citizens—every step of the way",
      curriculum_text1: "From Nursery through Primary School, the Crystal English Nursery and Primary School (CENPS) program sparks discovery, builds resilience, inspires faith, and deepens empathy.",
    ...
    fr: {
      ...
      curriculum_heading: "Former des penseurs perspicaces et des citoyens actifs, à chaque étape du processus",
      curriculum_text1: "De la maternelle à l'école primaire, le programme Crystal English Nursery and Primary School (CENPS) suscite la découverte, renforce la résilience, inspire la foi et approfondit l'empathie.",
      curriculum_text2: "À tous les niveaux, notre programme soigneusement conçu allie une indépendance accrue à la collaboration et une maîtrise de la matière à une exploration guidée par la curiosité. À l'école maternelle, les enfants apprennent dans un environnement basé sur le jeu où ils développent des compétences sociales, émotionnelles, motrices et linguistiques précoces grâce à une exploration interactive et à des activités créatives. À l'école primaire, un cadre académique structuré est proposé aux enfants pour qu'ils acquièrent des connaissances fondamentales en lecture, en calcul et en numératie, favorisant ainsi la pensée critique et l'apprentissage indépendant.",
      curriculum_text3: "Notre programme commence à l'école maternelle, où les jeunes apprenants sont nourris par des jeux interactifs qui développent des compétences sociales, émotionnelles, motrices et linguistiques essentielles ; il progresse ensuite jusqu'à l'école primaire, où les élèves s'appuient sur ces bases avec un mélange dynamique d'apprentissage académique et d'expériences pratiques qui encouragent la recherche indépendante et la résolution collaborative de problèmes.",
      curriculum_text4: "Nous vous invitons à découvrir nos programmes d’école maternelle et d’école primaire. Si vous avez des questions ou si vous êtes prêt pour les prochaines étapes, veuillez contacter notre bureau des admissions.",
